    ...
    public EntityModel<DireccionResponseDto> toModel(DireccionResponseDto direccion) {
        return EntityModel.of(
                ...
                linkTo(methodOn(DireccionControllerV2.class).listar()).withRel("direcciones"),
                 linkTo(methodOn(DireccionControllerV2.class).actualizar(direccion.getId(), null)).withRel("actualizar"),
                linkTo(methodOn(DireccionControllerV2.class).eliminar(direccion.getId())).withRel("eliminar")
            );
    }
}
